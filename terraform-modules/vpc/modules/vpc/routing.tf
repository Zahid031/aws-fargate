...
# Default route → NAT Gateway (shared or per-AZ depending on variable)
# The S3 gateway endpoint will also be associated with these tables
# (done in the vpc_endpoints module).
